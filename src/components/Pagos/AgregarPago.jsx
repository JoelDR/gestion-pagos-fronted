    ...
    <div className="mt-10 sm:mt-0">
      <Formik
        ...
        validate={(valores) => {
          let errores = {};
          if (!valores.deudor) {
            errores.nombre = 'Ingrese un deudor';
          } else if (!/^[a-zA-ZÀ-ÿ\s]{1,40}$/.test(valores.deudor)) {
            errores.deudor = 'El deudor solo puede contener letras y espacios'
          }
            ...
            <div className="md:grid md:grid-cols-3 md:gap-6">
              <div className="md:col-span-1">
                <div className="px-4 sm:px-0">
                  <h3 className="text-lg font-medium leading-6 text-gray-900">Información del pago</h3>
                  <p className="mt-1 text-sm text-gray-600">Registre todos los datos del pago para registrarlo</p>
                </div>
              </div>
                    ...
                    <div className="px-4 py-5 bg-white sm:p-6">
                      <div className="grid grid-cols-6 gap-6">
                        <div className="col-span-6 sm:col-span-3">
                          <label htmlFor="Deudor" className="block text-sm font-medium text-gray-700">
                            Deudor
                          </label>
                          <Field
                            type="tel"
                            id="deudor"
                            name="deudor"
                            className={`mt-2 border ${touched.deudor && errors.deudor? "border-rose-400" :"border-slate-400"} focus:outline-none text-gray-900 text-sm rounded-lg focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400 block w-full p-2.5`}
                            placeholder="Deudor"
                            />
