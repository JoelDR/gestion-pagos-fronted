              ...
              <Form>
                <div className="px-4 py-5 bg-white sm:p-6">
                  ...
                  <div className="px-4 py-3 mt-3 ml-2 bg-white text-right sm:px-6 flex justify-items-start w-3/4">
                    ...
                    <Link to="/menu/cobradores/lista" className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-rose-500 hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-400">Cancelar</Link>
                  </div>
                </div>
              </Form>
          </div>
